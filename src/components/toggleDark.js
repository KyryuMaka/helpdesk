...
function ToogleDarkButton(){
    ...
    return(
        <button id="theme-toggle" onClick={darkmode} type="button" className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none rounded-lg text-sm p-2.5">
