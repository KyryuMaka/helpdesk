...
function ToogleDarkButton(){
    ...
    return(
        <button id="theme-toggle" onClick={darkmode} type="button" 
            ...
            <svg id="theme-toggle-light-icon" className="hidden w-5 h-5" fill="currentColor" 
                viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 
                    4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 
                    ...
                    1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 
