...
import Logo from "../../images/logoHHH.svg"
            ...
            <nav className="bg-gray-200 border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-900">
                <div className="container flex flex-wrap items-center justify-between mx-auto">
                    <a href="/" className="flex items-center">
                        ...
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">HHH Helpdesk</span>
                    </a>
                    <button 
                    ...
                    <div className="hidden w-full md:block md:w-auto" id="navbar">
                        <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-white font-semibold
                            md:flex-row md:space-x-8 md:mt-0 md:text-sm  md:border-0 md:bg-gray-200 
